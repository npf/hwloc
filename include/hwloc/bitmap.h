...
/** \brief Parse a systemd-specific bitmap string and stores it in bitmap \p bitmap.
 *
 * \return 0 on success, -1 on error.
 */
HWLOC_DECLSPEC int hwloc_bitmap_systemd_sscanf(hwloc_bitmap_t bitmap, const char * __hwloc_restrict string);
